...
- Do NOT include any explanatory text, markdown formatting (like ```json), or any characters before or after the JSON structure.
- Ensure all strings within the JSON are properly escaped (e.g., newlines as \\n, quotes as \").
- If no custom facets are needed, you MUST return a JSON object with an empty "customFacets" object and a "customState" object indicating why none were needed.
